...
<div class="shop_table woocommerce-checkout-review-order-table">
	<div class="title row">
		<div class="product-name key"><?php _e( 'Product', 'woocommerce' ); ?></div>
		<div class="product-total value"><?php _e( 'Total', 'woocommerce' ); ?></div>
	</div>
	<div>
		<?php
	...
	<div>
		...
		<div class="row cart-subtotal">
			<div class="key"><?php _e( 'Subtotal', 'woocommerce' ); ?></div>
		...
		<?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
			<div class="row cart-discount coupon-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
				<div class="key"><?php wc_cart_totals_coupon_label( $coupon ); ?></div>
		...
		<?php foreach ( WC()->cart->get_fees() as $fee ) : ?>
			<div class="row fee">
				<div class="key"><?php echo esc_html( $fee->name ); ?></div>
			...
			<?php if ( 'itemized' === get_option( 'woocommerce_tax_total_display' ) ) : ?>
				<?php foreach ( WC()->cart->get_tax_totals() as $code => $tax ) : ?>
					<div class="row tax-rate tax-rate-<?php echo sanitize_title( $code ); ?>">
						<div class="key"><?php echo esc_html( $tax->label ); ?></div>
						<div class="value"><?php echo wp_kses_post( $tax->formatted_amount ); ?></div>
					</div>
				<?php endforeach; ?>
			<?php else : ?>
				<div class="row tax-total">
					<div class="key"><?php echo esc_html( WC()->countries->tax_or_vat() ); ?></div>
		...
		<div class="row order-total">
			<div class="key"><?php _e( 'Total', 'woocommerce' ); ?></div>
