...
* Open Sans, http://www.google.com/fonts/specimen/Open+Sans
  Copyright ©, Steve Matteson, Apache License version 2.0, http://www.apache.org/licenses/LICENSE-2.0
...
* Images used in screenshot
  ...
  Logo: Own Creation
  Copyright © 2016, WebAtome, GPL v3 or later, http://www.gnu.org/licenses/gpl-3.0.txt

* Images included inside images folder
  placeholder-blog.jpg
  Copyright © 2016, WebAtome, GPL v3 or later, http://www.gnu.org/licenses/gpl-3.0.txt

  placeholder-blog-380x250.jpg
  Copyright © 2016, WebAtome, GPL v3 or later, http://www.gnu.org/licenses/gpl-3.0.txt
...
martialwc WordPress Theme, Copyright (c) 2015, WebAtome
martialwc is distributed under the terms of the GNU GPL
...
= Theme Instruction =
Get theme instruction at https://docs.WebAtome.com/martialwc/

= Free Support =
Get free support at https://WebAtome.com/support-forum/
...
== TRANSLATIONS ==
If you want the theme to be translated into your language, feel free to contribute the translation over here https://translate.wordpress.org/projects/wp-themes/martialwc
...
* Tweaks - Add TGMPA to recommend WebAtome Demo Importer plugin
...
* Feature - Added compatibility for WebAtome Demo Importer plugin
...
* Added - Vertical Promo and Horizontal Promo widget for normal page
* Fixed - Advertisement widget to allow all image size
* Fixed - Adds support for PHP < 5.4

= Version 1.0.7.2 =
* Adds translation-ready tag
* Adds license for screenshot image
...
= Version 1.0.5 =
* Fixed - Hide Post Title not working
* Added - Attribution to images in screenshot

= Version 1.0.4 =
* Changed - Escaping of text on widgets.php
* Changed - Changed default number to 5 in widgets
