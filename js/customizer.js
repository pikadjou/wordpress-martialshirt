...
(function ( $ ) {
	...
	/*wp.customize( 'martialwc_primary_color', function ( value ) {
		value.bind( function ( primaryColor ) {
			// Store internal style for primary color
			var primaryColorStyle = '<style id="martialwc-internal-primary-color"> .navigation .nav-links a:hover,' +
			...
			$( 'head #martialwc-internal-primary-color' ).remove();
