	...
	<div id="content" class="site-content woocommerce">
		...
		<main id="main">
			<div class="tg-container">
				...
				<section class="product-collection martialwc-cat-color_<?php echo $woo_category->term_id; ?>">
					<div class="section-title-wrapper clearfix">
						...
						<div class="view-all">
							<a href="<?php echo esc_url( get_term_link( $woo_category->term_id ) ); ?>"><?php esc_html_e( 'View all', 'martialwc' ); ?></a>
					...
					<?php
						...
						<li class="product products-block tg-column-4">
							 ...
							 * @hooked martialwc_template_loop_product_thumbnail - 10 // See woocommerce.php line no: 19
							 */
							do_action( 'woocommerce_before_shop_loop_item_title', 'martialwc-square' );
							?>
							<div class="products-content-wrapper">
								 ...
								 * @hooked martialwc_template_loop_add_to_wishlist - 10 // See woocommerce.php line no: 27
								 */
